      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="">
              ...
              <div class="mb-4">
                  ...
                  <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="meta_keyword" placeholder="Enter Seo keyword" wire:model="meta_keyword">
              ...
              <div class="mb-4">
                  ...
                  <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="meta_description" wire:model="meta_description" placeholder="Enter Seo description"></textarea>
