...
<div class="bg-green-550 h-screen">
        <div class=" container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          ...
          <div class="w-full md:w-2/3 flex flex-col mb-16 items-center mt-5 text-center">
            ...
            <p class="text-sm mt-2 text-white mb-8 w-full"><a class="py-3 px-5 border rounded-lg" href="/">Retour vers l'acceuil</a></p>
            <div class="flex">
              <button class=" inline-flex py-3 px-5 rounded-lg items-center focus:outline-none">
              ...
              <button class=" inline-flex py-3 px-5 rounded-lg items-center ml-4 focus:outline-none">
