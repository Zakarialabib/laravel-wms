            ...
            <div class="bg-white overflow-hidden sm:rounded-lg px-4 py-4">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-3 sm:col-span-3">
                        ...
                        {!! Form::password('password', ['placeholder' => 'Password', 'class' => 'p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500"']) !!}
                    ...
                    <div class="col-span-3 sm:col-span-3">
                        ...
                        {!! Form::password('confirm-password', ['placeholder' => 'Confirm Password', 'class' => 'p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500"']) !!}
                    </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 text-center">
                        ...
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Enregistrer</button>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
