        ...
        <form wire:submit.prevent="store">
            ...
            <div class="flex flex-wrap -m-2">
                ...
                <div class="w-1/2 p-2">
                    ...
                    <input
                        class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                        type="text" name="phone" value="{{ old('phone') }}" wire:model="phone">
                ...
                <div class="w-1/2 p-2">
                    ...
                    <input
                        class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                        type="email" name="email" value="{{ old('address') }}" wire:model="email">
                ...
                <div class="w-1/2 p-2">
                    ...
                    <input
                        class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                        type="text" name="address" value="{{ old('address') }}" wire:model="address">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border flex td class=">
                            ...
                            {{--        <button wire:click="edit({{ $customer->id }})" class="bg-blue-500
                            hover:bg-blue-700 text-white font-bold px-5 py-2.5 rounded">Modifier</button>
                            <button wire:click="delete({{ $customer->id }})"
                                class="bg-red-500 hover:bg-red-700 text-white font-bold px-2 py-2 rounded">Supprimer</button>--}}
