...
<div class="border-2 border-green-600 shadow-xl">
    <input type="text" wire:model="search"  class="shadow appearance-none border border-gray-300 rounded w-full py-2 px-3  my-5  ocus:shadow-outline" placeholder="Recherche Region ou Ville" />
